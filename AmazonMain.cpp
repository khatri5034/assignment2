			...
			case 3: //create product
			{
			    ...
			    switch (productType) //switch case for product type
			    {
			        case 1: //media
			        {
			            ...
			            Media* media = new Media(name, description, type, targetAudience); //create media object
			        ...
			        case 2: //good
			        {
			            ...
			            Good* good = new Good(name, description, expirationDate, quantity); //create good object
			            cout << endl;
